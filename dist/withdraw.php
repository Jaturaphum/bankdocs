...
<head>
    ...
    <link rel="stylesheet" href="style/style_withdraw.css">
        ...
        <div class="column">
            <div class="bon">
                ...
                <div class="input-group">
                    ...
                    <script>
                        function confirmwithdraw(balance, withdrawAmount) {
                            if (balance < withdrawAmount) {
                                alert("ไม่สามารถทำการถอนได้ เนื่องจากยอดเงินไม่เพียงพอ");
                                return false;
                            } else {
                                let cancel = confirm("ยันยินเพื่อทำการถอนไหม?");
                                if (cancel) {
                                    alert("ได้ยันยืนการถอนออกจากระบบแล้ว");
                                } else {
                                    alert("ได้ยกเลิกการถอนแล้ว!");
                                }
                                return cancel;
                            }
                        }
